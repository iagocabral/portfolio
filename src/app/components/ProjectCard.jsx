...
const ProjectCard = ({ imgUrl, titlle, description, gitUrl, previewURL }) => {
    return (
        <div>
            <div
            ...
            <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
                <Link
                  href={gitUrl}
                  className="h-14 w-14 mr-2 border-2 relative rounded-full border-[#ADB7BE] group-hover/link:text-white group/link"
                >
                ...
                <Link
                  href={previewURL}
                  className="h-14 w-14 border-2 relative rounded-full border-[#ADB7BE] group-hover/link:text-white group/link"
                >
            ...
            <div className="text-white rounded-b-xl mt-3 bg-[#181818] px-4">
                <h5 className="font-xl font-semibold mb-2">{titlle}</h5>
